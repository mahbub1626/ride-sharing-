        ...
        <div className=''>
            <div className='flex flex-col-reverse lg:grid lg:grid-cols-2'>
                <div className='lg:pt-52'>
                    <img className='busShape lg:grid hidden lg:w-[981px] absolute' src={BusShape} alt="" />
                    <div className='relative lg:w-[800px] lg:h-[400px] grid lg:grid-cols-3 gap-4 justify-items-center items-center ml-2 py-28'>
                        {/* dynamic card */}
                        {
                            data.map(d => <div
                                key={d.id}
                                className={`grid-flow-col bg-white p-4 ${d.ca}
                                 text-center rounded-xl drop-shadow-xl lg:w-[232px] max-w-[232px] lg:h-[254px] mx-auto`}
                                >
                                    <img src={d.img} alt="" />
